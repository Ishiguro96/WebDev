    ...
    <div class="row">
      ...
      <div class="col-md order-md-1 h-100 content">
        ...
        <?php
          ...
          $sql = "SELECT news.ID, news.title, news.author, news.date, news.image, news.content, news_category.description, news.source FROM news INNER JOIN news_category ON news.news_category = news_category.ID WHERE news.news_category='3' ORDER BY date DESC LIMIT 30";
